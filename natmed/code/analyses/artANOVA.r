...
# load reference set #TODO: transition to GEO data
...
names(data_03$art_aov_contrast_tidy) <- data_03$variable %>% as.character()
names(data_03$art_aov_contrast_cld) <- data_03$variable %>% as.character()
