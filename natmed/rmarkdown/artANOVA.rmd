...
```
<br>
<span style="font-family: Helvetica; font-size: 20px;">&#8226; This is what the data look like after we have organized them. Each row of the dataframe contains the data for each score, the category it belongs to, it's category annotation, it's long-format name, and the name of the variable in the data.</strong></span>
