...
# The effect of treatment on molecular scores using aligned-rank transformed analysis of variance (artANOVA) {.tabset}
...
# The effect of treatment on injury scores using linear-mixed model {.tabset}
...
# The effect of treatment on gene expression {.tabset}
