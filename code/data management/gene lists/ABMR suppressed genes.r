...
genes_ABMR_suppressed <- data %>%
    dplyr::slice_min(`corrRej7AA5-FABMR`, n = 100) %>%
...
save(genes_ABMR_suppressed, file = paste(saveDir, "ABMR_activity_genes.RData", sep = ""))
...
# MAKE FLEXTABLE ####
flextable <- genes_ABMR_suppressed %>%
