...
source("code/functions/plot.gg_volcano.r")
# load DE data
load("results/deg.RData")
# load enrichment results
load("results/gsea_summary.RData")
...
col_baseline_vs_week52_immune_response <- pal_npg()(9)[9]
col_baseline_vs_week52_injury_response <- pal_npg()(9)[3]
...
curves_baseline_vs_week24_immune_response <- ggplot2::geom_curve(
    ...
    col = col_baseline_vs_week24_immune_response,
    curvature = 0.325,
    angle = 45,
    linewidth = 0.1,
    ncp = 1
...
curves_baseline_vs_week52_immune_response <- ggplot2::geom_curve(
    ...
    col = col_baseline_vs_week52_immune_response,
    curvature = 0.65,
    angle = 45,
    linewidth = 0.1,
    ncp = 1
...
curves_baseline_vs_week52_injury_response <- ggplot2::geom_curve(
    ...
    col = col_baseline_vs_week52_injury_response,
    curvature = -0.15,
    angle = 90,
    linewidth = 0.1,
    ncp = 1
