...
# ggsave(
#     filename = paste(saveDir, "Felzartamab cfdna quantile regression plots.png"),
#     plot = panels,
#     dpi = 300,
#     width = 60,
#     height = 30,
...
# )
ggsave(
    filename = paste(saveDir, " Felzartamab cfdna quantile regression plots (9 and 19 removed).png"),
    plot = panels,
    dpi = 300,
    width = 60,
    height = 30,
